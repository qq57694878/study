 ...
 */
package com.dhc.tools.java;

import com.dhc.tools.util.StringUtility;
...
public class FullyQualifiedJavaType implements
    ...
    private void parse(String fullTypeSpecification) {
        ...
        if (spec.startsWith("?")) { //$NON-NLS-1$
            ...
            if (index == -1) {
                ...
                if (endIndex == -1) {
                     throw new RuntimeException("runtime exception:ge shi error！"); //$NON-NLS-1$
    ...
    private void genericParse(String genericSpecification) {
        ...
        if (lastIndex == -1) {
            ...
            throw new RuntimeException("runtime exception: geshi error!"); //$NON-NLS-1$
        }
        ...
        if (openCount != 0) {
            throw new RuntimeException("runtime exception:openCount==0!"); //$NON-NLS-1$
        }
