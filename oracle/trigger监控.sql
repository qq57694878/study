...
RETURN VARCHAR2 IS
  V_SQL  VARCHAR2(4000):='';
    V_WHERE VARCHAR2(4000):='';
BEGIN
  FOR V_CUR1 IN (SELECT ljl.section1_6.A.column_name FROM user_cons_columns ljl.section1_6.A, user_constraints ljl.section1_6.B WHERE ljl.section1_6.A.constraint_name = ljl.section1_6.B.constraint_name  AND ljl.section1_6.B.constraint_type='P' AND ljl.section1_6.A.table_name=V_TABLE_NAME)
LOOP
