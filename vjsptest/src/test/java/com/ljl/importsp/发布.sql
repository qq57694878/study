CREATE OR REPLACE PROCEDURE PROC_SYS_INSERT_MK_16(v_TB_SP_D_TYPE_ID IN VARCHAR2 DEFAULT NULL, --1级分类编码 主
  ...
  --增加的字段start
                                                  v_10012023        IN VARCHAR2 DEFAULT NULL, --商户备注,sg_shbz 自
                                                  v_10010000        IN VARCHAR2 DEFAULT NULL, --业务类型(国检|扩展1),sg_bszy 自
                                                  v_10008367        IN VARCHAR2 DEFAULT NULL, --业务类型(商备),sg_ywlx 自
                                                  v_10008684        IN VARCHAR2 DEFAULT NULL, --申报单位,sg_sbdw 自
                                                  v_10008686        IN VARCHAR2 DEFAULT NULL, --货号,sg_sbhh 自
                                                  v_10008689        IN VARCHAR2 DEFAULT NULL, --物资序号,sg_wzxh 自
                                                  ...
                                                  v_10008424        IN VARCHAR2 DEFAULT NULL, --备案名称,sg_baname 自
                                                  v_10008792        IN VARCHAR2 DEFAULT NULL, --电商主体备案状态,sg_dsztbazt 自
                                                  v_10009894        IN VARCHAR2 DEFAULT '311000', --商品经营范围区域(311000:上海洋山局本部),busregion 自
                                                  v_10008701        IN VARCHAR2 DEFAULT NULL, --适用标准国别(国家三字码)(国检),sg_sybzgb 自
                                                  v_10008366        IN VARCHAR2 DEFAULT '2249', --申报关区,sg_sbgq 自
                                                  v_10008369        IN VARCHAR2 DEFAULT '2', --海关一线备案状态(2:通过),sg_hgzt 自
                                                  v_10008368        IN VARCHAR2 DEFAULT '2', --国检备案状态(2:通过),sg_gjzt 自
                                                  ...
                                                  v_10008709        IN VARCHAR2 DEFAULT '0', --是否禁止进境物标识(国检)0:允许进境,sg_sfjzjjbs 自
  ...
  BEGIN
    ...
    SELECT COUNT(1)
    INTO REPEAT
    FROM TS_SP_INFO com.ljl.section1_6.A
      INNER JOIN TDY_TS_SP_INFO com.ljl.section1_6.B ON com.ljl.section1_6.A.TS_SP_INFO_ID = com.ljl.section1_6.B.TDY_ZID
    WHERE com.ljl.section1_6.A.TS_SP_TXM = BANO AND com.ljl.section1_6.B.SG_SHBZ = v_10008346;
    ...
    THEN
      ...
      UPDATE TDY_TS_SP_INFO SET SG_SHBZ = v_10012023, SG_BSZY = v_10010000, SG_YWLX = v_10008367, SG_SBDW = v_10008684, SG_SBHH = v_10008686, SG_WZXH = v_10008689, SG_GBXH = v_10008889, DJSBDW = v_10012144, CARGOPLACE = v_10009893, SG_BANAME = v_10008424, SG_DSZTBAZT = v_10008792, BUSREGION = v_10009894, SG_SYBZGB = v_10008701, SG_SBGQ = v_10008366, SG_HGZT = v_10008369, SG_GJZT = v_10008368, SG_SPNBHH = v_10008692, SG_DYJLDW = v_10008693, SG_GJBZ = v_10008694, SG_SPSLGJ = v_10008695, SG_BADJ = v_10008699, SG_DEJLDW = v_10008700, SG_ZJYCPBZ = v_10008702, SG_SPBABH = v_10008703, SG_SPWZID = v_10008704, SG_XZLSPBZ = v_10008705, SG_ZDSJBJ = v_10008706, SG_SPDWGJ = v_10008707, SG_SCCJ = v_10008708, SG_SFJZJJBS = v_10008709, SG_3CZS = v_10012192 WHERE TDY_ID = V_TDY_TS_SP_INFO_ID;
